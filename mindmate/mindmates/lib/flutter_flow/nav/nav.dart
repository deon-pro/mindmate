...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CreateDogProfileWidget(  token:
                params.getParam('token', ParamType.String),),
        ),
        FFRoute(
          name: 'createYourProfile',
          path: '/createYourProfile',
          builder: (context, params) => CreateYourProfileWidget( token:
                params.getParam('token', ParamType.String)),
        ),
        FFRoute(
          name: 'forgotPassword',
        ...
        FFRoute(
          ...
          builder: (context, params) => StoryDetailsWidget(
            ...
            userId: 
                params.getParam('userId', ParamType.String) ,
            username: 
                params.getParam('userName', ParamType.String) ,
        ...
        FFRoute(
          ...
          builder: (context, params) => ViewProfilePageOtherWidget(
            userDetails: params.getParam('userDetails', ParamType.Document), username: '',
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          asyncParams: {
            'chatUser': getDoc(['users'], UsersRecord.fromSnapshot),
             'chatUsers': getDoc(['users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => ChatPageWidget(
            chatUser: params.getParam('chatUser', ParamType.Document),
            chatUsers: params.getParam('chatUsers', ParamType.Document),
