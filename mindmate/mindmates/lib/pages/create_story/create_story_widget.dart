              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _model.uploadedFileUrl3.isNotEmpty ||
                            _model.uploadedFileUrl2.isNotEmpty
                        ? FFButtonWidget(
                            onPressed: () async {
                              var story;
                              if (_model.uploadedFileUrl3.isEmpty) {
                                story = _model.uploadedFileUrl2;
                              } else if (_model.uploadedFileUrl2.isEmpty) {
                                story = _model.uploadedFileUrl3;
                              }
