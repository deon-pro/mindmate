...
class SubmitUserReport extends StatelessWidget {
  final reason;
  final reporteeId;
  final username;
  const SubmitUserReport(
      {super.key, this.reason, this.reporteeId, this.username});

  void notify(String userid) {
    String message =
        'Your report regarding user $username under category title $reason has been received, our team is working to look into the matter. Please note that your identity is never revealed to the other user.';
            ...
            Column(
              ...
              children: [
                Container(
                  ...
                  child: Text('Report account $username for $reason?',
              ...
              child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    CollectionReference messagesRef =
                        firestore.collection('accountReports');
