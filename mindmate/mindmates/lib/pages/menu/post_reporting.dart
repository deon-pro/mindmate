...
import 'package:mindmates/pages/menu/confirm_post_report.dart';

class PostAndDataReporting extends StatelessWidget {
  final reporteeId;
  final postId;
  const PostAndDataReporting({super.key, this.reporteeId, this.postId});
          ...
          return Column(
            children: [
              Container(
                ...
                child: Text('Select the reason to report this post:',
                    style: TextStyle(
                      // fontSize: 12,
                    ...
                    return InkWell(
                      onTap: () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => SubmitPostReport(
                                  reason: reason,
