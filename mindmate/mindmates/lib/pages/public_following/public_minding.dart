...
class PublicFollowings extends StatefulWidget {
  final userid;
  const PublicFollowings({super.key, required this.userid});

  @override
  State<PublicFollowings> createState() => _PublicFollowingsState();
}

class _PublicFollowingsState extends State<PublicFollowings> {
                                      ...
                                      SizedBox(
                                          width: isFollowingBack
                                              ? MediaQuery.of(context)
                                                  ...
                                                  .22
                                              : 4,
                                          child: followings[index].userid == userAc!.uid? null:
                                          isFollowingBack
                                              ? ElevatedButton(
                                                  onPressed: () {
                                                    ...
                                                    void unfollow() async {
                                                      ...
                                                      Navigator.of(context)
                                                        ...
                                                        MaterialPageRoute(
                                                            builder: (context) =>
                                                                PublicFollowings(userid: widget.userid,)),
                                                      );
                                                    }
