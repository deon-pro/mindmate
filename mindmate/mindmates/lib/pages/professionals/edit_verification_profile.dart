...
class VerificationProfileUpdate extends StatefulWidget {
  @override
  _VerificationProfileUpdateState createState() =>
      _VerificationProfileUpdateState();
}

class _VerificationProfileUpdateState extends State<VerificationProfileUpdate> {
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text('* Your request is being process. Please be patient as the verification process continues.',
                      style: TextStyle(
