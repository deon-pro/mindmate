...
class commentsUserWidget extends StatefulWidget {
  const commentsUserWidget({
    Key? key,
    this.story,
  }) : super(key: key);
  ...
  @override
  _commentsUserWidgetState createState() => _commentsUserWidgetState();
}

class _commentsUserWidgetState extends State<commentsUserWidget> {
