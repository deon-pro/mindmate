...
class UserPostsRecord extends FirestoreRecord {
  ...
  // Factory method to create instances using the private constructor
  factory UserPostsRecord.fromDocumentSnapshot(DocumentSnapshot snapshot) {
    final data = snapshot.data() as Map<String, dynamic>;

    // // Handle the 'timePosted' field, assuming it's a Timestamp
    // final Timestamp timestamp = data['timePosted'] as Timestamp;
    // final DateTime dateTime = timestamp.toDate();

    // Create and return an instance of UserPostsRecord
    return UserPostsRecord._(
      snapshot.reference,
      data,
    );
  }
  ...
  // "canComment" field.
  bool? _canComment;
  bool get canComment => _canComment ?? false;
  bool hascanComment() => _canComment != null;
  ...
  void _initializeFields() {
    ...
    _canComment = snapshotData['canComment'] as bool?;
  }
